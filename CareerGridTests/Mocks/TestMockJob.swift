...
extension Job {
    static let mock1 = Job(id: "1",
                           title: "Senior SRE",
                           company: Company(id: "1", name: "Stripe", address: "San Francisco, CA, USA"),
    ...
    static let mock2 = Job(id: "3",
                           title: "Agile Coach",
                           company: Company(id: "3", name: "Airbnb", address: "San Francisco, CA, USA"),
